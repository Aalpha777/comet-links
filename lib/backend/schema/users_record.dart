...
class UsersRecord extends FirestoreRecord {
  ...
  // "launchpads" field.
  List<DocumentReference>? _launchpads;
  List<DocumentReference> get launchpads => _launchpads ?? const [];
  bool hasLaunchpads() => _launchpads != null;
  ...
  void _initializeFields() {
    ...
    _launchpads = getDataList(snapshotData['launchpads']);
...
class UsersRecordDocumentEquality implements Equality<UsersRecord> {
  ...
  bool equals(UsersRecord? e1, UsersRecord? e2) {
    ...
    return e1?.email == e2?.email &&
        ...
        listEquality.equals(e1?.launchpads, e2?.launchpads) &&
